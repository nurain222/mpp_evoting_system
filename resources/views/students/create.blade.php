    ...
    <div class="column">
        <form method="POST" action="{{ route('students.store') }}">
            ...
            <div class="container">
                <div class="card6">
                    ...
                    <input class="inputbox" type="email" name="email" style="text-align:left;" autocomplete="off" placeholder="eg: 2021693158@student.uni.edu.my" required>
        ...
        <div class="popup-overlay" id="SuccessBox">
            <div class="popup-box-container">
                ...
                <div class="popup-message-container">
                    ...
                    <p class="text9"> Student is added to the database. </p>
                </div>
        ...
        <script> 
            ...
            SuxOkBtn.addEventListener('click', ()=> {
                ...
                location.replace("{{ route('students.index') }}");
            })
        </script>
    @endif
